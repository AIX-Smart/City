...
public class DummyContent {
    ...
    public static Tag BAR_TAG = new Tag(1, "Bar");

    public static Tag RESTAURANT_TAG = new Tag(2, "Restaurant");
    ...
    static {
        ...
        listing.addPost(new Event(-1, content, System.currentTimeMillis(), 0, AIxLoginModule.getInstance().getLoggedInUser().getId(), false, GINBAR, 0));
