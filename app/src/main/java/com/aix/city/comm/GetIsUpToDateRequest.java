 ...
 */
public class GetIsUpToDateRequest extends AIxJsonRequest<Boolean> {

    private final Post newestPost;
    private final ListingSource listingSource;

    public GetIsUpToDateRequest(Response.Listener<Boolean> listener, Response.ErrorListener errorListener, Post newestPost, ListingSource listingSource){
